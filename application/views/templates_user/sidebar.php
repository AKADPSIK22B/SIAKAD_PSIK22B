            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('user/tagihan') ?>">Tagihan</a>
                        <a class="collapse-item" href="<?php echo base_url('user/beasiswa') ?>">Beasiswa</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/matakuliah') ?>">Potongan</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/mahasiswa') ?>">UKT</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="login.html">Indentitas</a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <?php if ($profil_mahasiswa): ?>
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=  $profil_mahasiswa->nama_lengkap ?></span>
                                    <!-- Tampilkan data profil lainnya sesuai kebutuhan -->
                                <?php else: ?>

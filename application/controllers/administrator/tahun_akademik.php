...
public function tambah_tahun_akademik_aksi() {
    ...
    Data tahun Akademik Berhasil Ditambahkan! <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
   </div>');
...
public function _rules(){
    ...
    $this->form_validation->set_rules('semester','semester', 'required', ['required' => 'Semesterdiisi!']);
...
public function update_aksi() {
    ...
    $data = array (
        ...
        $where = array (
            ...
            $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
                   Data Tahun Akademik Berhasil Diupdate! <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>');
        redirect('administrator/tahun_akademik');
}
...
public function delete($id){
    ...
    Data Tahun Akademik Berhasil Dihapus! <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
   </div>');
    redirect('administrator/tahun_akademik');
}
